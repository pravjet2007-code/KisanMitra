...
tagline: 'Every scheme you deserve, found instantly.',
description: 'Enter your profile details once and KisanMitra matches you with all eligible central and state government schemes — PM Kisan, KCC, Pradhan Mantri Fasal Bima Yojana, fertilizer subsidies, Soil Health Card, and more. Apply directly without visiting any office.',
capabilities: [
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden">
        ...
        <div className="relative max-w-[1280px] mx-auto px-4 md:px-8 lg:px-12">
          <span className="inline-block px-4 py-1.5 bg-white/10 border border-white/15 text-white/80 text-sm font-bold rounded-full mb-5 backdrop-blur-sm">
            <Sprout className="w-4 h-4 inline mr-1.5 -mt-0.5" /> Platform Features
          </span>
          <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-5 max-w-3xl">
            Everything You Need, From Soil to Sale
          </h1>
          <p className="text-white/50 text-lg max-w-2xl leading-relaxed">
            5 integrated modules that work together as a data flywheel — improving predictions, pricing, and outcomes every season.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-12">
          <div className="text-center mb-14">
            ...
            <p className="text-medium text-lg max-w-2xl mx-auto">
              Accessibility, security, and intelligence designed for real-world conditions.
            </p>
          </div>
      ...
      <section className="relative py-16 md:py-20 overflow-hidden">
        ...
        <div className="relative max-w-[800px] mx-auto px-4 md:px-8 text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-white mb-4">
            Start Using KISAN MITRA Today
          </h2>
          <p className="text-white/50 text-lg mb-8">
            Set up your farm profile and begin receiving AI-powered recommendations in minutes.
          </p>
