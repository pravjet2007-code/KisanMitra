...
const allListings = [
  { id: 1, farmer: 'Available Farmer', score: 4.7, location: 'Punjab', distance: '52 km', crop: 'Wheat HD-2967', qty: '18 Q', price: 2250, grade: 'A', moisture: '11.5%', verified: true, droneData: true, harvest: 'Mar 15', organic: false, category: 'wheat' },
  { id: 2, farmer: 'Available Farmer', score: 4.2, location: 'Punjab', distance: '78 km', crop: 'Wheat PBW-343', qty: '25 Q', price: 2180, grade: 'A', moisture: '12.1%', verified: true, droneData: false, harvest: 'Mar 18', organic: false, category: 'wheat' },
  { id: 3, farmer: 'Available Farmer', score: 4.9, location: 'Punjab', distance: '35 km', crop: 'Wheat HD-2967', qty: '12 Q', price: 2300, grade: 'A+', moisture: '11.2%', verified: true, droneData: true, harvest: 'Mar 12', organic: true, category: 'wheat' },
  { id: 4, farmer: 'Available Farmer', score: 4.5, location: 'Madhya Pradesh', distance: '120 km', crop: 'Soybean JS-335', qty: '30 Q', price: 4200, grade: 'A', moisture: '10.8%', verified: true, droneData: true, harvest: 'Mar 20', organic: false, category: 'soybean' },
  { id: 5, farmer: 'Available Farmer', score: 4.0, location: 'Maharashtra', distance: '95 km', crop: 'Rice Basmati', qty: '15 Q', price: 3800, grade: 'A', moisture: '13.0%', verified: false, droneData: false, harvest: 'Apr 5', organic: false, category: 'rice' },
  { id: 6, farmer: 'Available Farmer', score: 4.8, location: 'Punjab', distance: '45 km', crop: 'Mustard Pusa Bold', qty: '10 Q', price: 5100, grade: 'A+', moisture: '8.5%', verified: true, droneData: true, harvest: 'Mar 8', organic: true, category: 'mustard' },
  { id: 7, farmer: 'Available Farmer', score: 3.8, location: 'Uttar Pradesh', distance: '200 km', crop: 'Chickpea Desi', qty: '20 Q', price: 4800, grade: 'B', moisture: '11.0%', verified: true, droneData: false, harvest: 'Mar 25', organic: false, category: 'chickpea' },
  { id: 8, farmer: 'Available Farmer', score: 4.6, location: 'Rajasthan', distance: '150 km', crop: 'Wheat Lok-1', qty: '35 Q', price: 2100, grade: 'A', moisture: '11.8%', verified: true, droneData: true, harvest: 'Mar 22', organic: false, category: 'wheat' },
  { id: 9, farmer: 'Available Farmer', score: 4.3, location: 'Telangana', distance: '180 km', crop: 'Rice Sona Masoori', qty: '40 Q', price: 3200, grade: 'A', moisture: '12.5%', verified: true, droneData: false, harvest: 'Apr 10', organic: false, category: 'rice' },
];

const categories = ['All', 'Wheat', 'Rice', 'Mustard', 'Soybean', 'Chickpea'];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-[1280px] mx-auto px-4 md:px-8 lg:px-12 py-16 md:py-20">
          <h1 className="font-heading text-3xl md:text-4xl font-bold text-white mb-3">
            KISAN MITRA Marketplace
          </h1>
          <p className="text-white/50 text-lg mb-6 max-w-xl">
            Browse verified farm listings with quality data, drone maps, and Farmer Score.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 max-w-2xl">
            <div className="flex-1 relative">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted" />
              <input type="text" placeholder="Search crops, locations..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full pl-12 pr-4 py-4 rounded-xl text-sm bg-white shadow-lg focus:ring-2 focus:ring-terracotta/30 outline-none" />
            </div>
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-12 py-8">
          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <div className="relative">
              <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="appearance-none bg-light rounded-xl px-4 py-2.5 pr-10 text-sm text-dark cursor-pointer focus:ring-2 focus:ring-terracotta/20 outline-none border border-border">
                ...
                <option value="score">Farmer Score</option>
            ...
            <div className="ml-auto text-sm text-muted">{filtered.length} listing{filtered.length !== 1 ? 's' : ''}</div>
          </div>
        </div>
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="font-heading text-xl font-semibold text-black mb-2">No listings found</h3>
            <p className="text-muted">Adjust your filters or search query.</p>
          </div>
        ) : (
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-4">
                    <div className="bg-offwhite rounded-lg p-2.5">
                      <p className="text-[10px] text-muted uppercase tracking-wider">Grade</p>
                      <p className="text-sm font-semibold text-black">{listing.grade}</p>
                    </div>
                    <div className="bg-offwhite rounded-lg p-2.5">
                      <p className="text-[10px] text-muted uppercase tracking-wider">Moisture</p>
        ...
        <div className="mt-12 bg-white rounded-2xl p-6 shadow-xs border border-border">
          <h3 className="font-heading text-lg font-semibold text-black mb-4 flex items-center gap-2">
            <TrendingUp className="w-5 h-5 text-terracotta" /> Market Insights
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { crop: 'Wheat', avg: '₹2,210/q', trend: '↑ 5.2%', positive: true },
              { crop: 'Rice', avg: '₹3,500/q', trend: '↑ 2.8%', positive: true },
              { crop: 'Mustard', avg: '₹5,050/q', trend: '↓ 1.5%', positive: false },
              { crop: 'Soybean', avg: '₹4,150/q', trend: '↑ 3.1%', positive: true },
            ].map((insight, i) => (
